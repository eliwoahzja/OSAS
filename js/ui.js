...
const FA = {
  ...
  inbox: 'inbox',
  info: 'circle-info',
  local_police: 'handcuffs',
  logout: 'arrow-right-from-bracket',
  map: 'map',
  medical_services: 'kit-medical',
  menu: 'bars',
  notifications: 'bell',
  person: 'user',
  ...
  verified_user: 'certificate',
  warning: 'triangle-exclamation',
};

export function icon(name, cls = 'text-sm') {
  const faIcon = FA[name] || name || 'circle';
  return h('i', { class: `fa-solid fa-${faIcon} ${cls}`, 'aria-hidden': 'true' });
}
